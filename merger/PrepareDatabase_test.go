		...
		},
		{
			...
			args: args{
				...
				left: []*model.Location{
					...
					{KeySymbol: sql.NullString{"nwtsty", true}, MepsLanguage: 0},
					{KeySymbol: sql.NullString{"nwt", true}, MepsLanguage: 0},
					{DocumentID: sql.NullInt32{1, true}, KeySymbol: sql.NullString{"nwtsty", true}, MepsLanguage: 1},
					{Track: sql.NullInt32{1, true}, KeySymbol: sql.NullString{"nwtsty", true}, MepsLanguage: 1},
				},
				right: []*model.Location{
					{KeySymbol: sql.NullString{"nwt", true}, MepsLanguage: 0},
					{KeySymbol: sql.NullString{"nwt", true}, MepsLanguage: 1},
					{KeySymbol: sql.NullString{"nwtsty", true}, MepsLanguage: 0},
					{DocumentID: sql.NullInt32{1, true}, KeySymbol: sql.NullString{"nwt", true}, MepsLanguage: 1},
					{Track: sql.NullInt32{1, true}, KeySymbol: sql.NullString{"nwt", true}, MepsLanguage: 1},
				},
			},
			want: args{
				left: []*model.Location{
